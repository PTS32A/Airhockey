...
//                    result.x = (float)p.getPosX().get() + (int)Math.round(radius * Math.cos(Math.toRadians(330)));
                    xPosBat.bind(Bindings.add(p.getPosX(), (int)Math.round(radius * Math.sin(Math.toRadians(240)))));
                    yPosBat.bind(Bindings.add(p.getPosY(), (int)Math.round(radius * Math.cos(Math.toRadians(240)))));
...
//                    result.x = (float)p.getPosX().get() + (int)Math.round(radius * Math.cos(Math.toRadians(210)));
                    xPosBat.bind(Bindings.subtract(p.getPosX(), (int)Math.round(radius * Math.sin(Math.toRadians(240)))));
                    yPosBat.bind(Bindings.add(p.getPosY(), (int)Math.round(radius * Math.cos(Math.toRadians(240)))));
                    batBouncePosition = new Vector2((float)xPosBat.get(), (float)yPosBat.get());
                } else {
                    direction = 0;
